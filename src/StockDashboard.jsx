        ...
        <div style={styles.card}>
          ...
          <div style={styles.grid}>
            ...
            <Row
              ...
              value={`${result.technicalAlignment.bullPct}% Bull / ${result.technicalAlignment.bearPct}% Bear`}
            />
          ...
          {result.signal ? (
            ...
            <div style={styles.noSignalBox}>
              Abhi koi clear confluence signal nahi bana hai is stock mein. Trend/momentum/volatility
              ek line mein nahi hain.
            </div>
          )}
        </div>
      )}
