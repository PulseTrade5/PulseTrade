...
const supabase = createClient(
  ...
  process.env.SUPABASE_SERVICE_ROLE_KEY // service role needed to write
);
...
export default async function handler(req, res) {
  ...
  // Protect the scrape trigger with a simple secret so randoms can't hammer NSE via your route
  if (action === "fetch") {
