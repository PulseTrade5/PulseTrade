...
function RefundPage() {
  return (
    <div style={{ backgroundColor: '#0D1117', color: '#E8E6E0', minHeight: '100vh', padding: '40px 20px', maxWidth: 720, margin: '0 auto' }}>
      ...
      <p style={{ marginBottom: 16, lineHeight: 1.7 }}>Last updated: June 2026</p>
      <h2 style={{ color: '#D8A33D', marginBottom: 12 }}>Refund Policy</h2>
      <p style={{ marginBottom: 16, lineHeight: 1.7 }}>We offer a 7-day refund policy from the date of purchase. If you are not satisfied with PulseTrade, contact us within 7 days for a full refund.</p>
      <h2 style={{ color: '#D8A33D', marginBottom: 12 }}>How to Request a Refund</h2>
      <p style={{ marginBottom: 16, lineHeight: 1.7 }}>Email us at <span style={{ color: '#D8A33D' }}>support@pulsetrade.in</span> with your registered email and order ID. Refunds are processed within 5-7 business days.</p>
      <h2 style={{ color: '#D8A33D', marginBottom: 12 }}>Cancellations</h2>
      <p style={{ marginBottom: 16, lineHeight: 1.7 }}>You can cancel your subscription anytime. Cancellation will take effect at the end of your current billing period. No partial refunds for unused days beyond the 7-day window.</p>
      <a href="/" style={{ color: '#D8A33D' }}>← Back to Home</a>
    </div>
  );
}
